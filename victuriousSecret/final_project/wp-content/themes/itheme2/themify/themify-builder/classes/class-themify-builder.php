...
if ( ! class_exists( 'Themify_Builder' ) ) {
	...
	class Themify_Builder {
		...
		function get_template_module( $mod, $echo = true, $wrap = true, $class = null, $identifier = array() ) {
			...
			if ( $wrap ) {
				ob_start(); ?>
				<div class="themify_builder_module_front clearfix module-<?php echo $mod['mod_name']; ?> active_module <?php echo $class; ?>" data-module-name="<?php echo esc_attr( $mod['mod_name'] ); ?>">
