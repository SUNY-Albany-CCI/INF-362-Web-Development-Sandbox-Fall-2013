						...
						<div id="styling-<?php echo themify_scrub_func($config['panel']['styling']['tab']['title']); ?>" class="subtab">
							...
							if(is_array($config['panel']['styling']['tab']['element'])){
								if(isset($config['panel']['styling']['tab']['element']['title']) && isset($config['panel']['styling']['tab']['element']['selector'])){
									echo themify_container(themify_scrub_func($tab['id']), $config['panel']['styling']['tab']['element']); 
								} else {
...
function themify_after_meta_field($after = null){
	...
	function themify_get_image( $args ) {
		...
		if( in_the_loop() && ( ! isset( $ignore ) || !$ignore ) ) {
			...
			if ( 'no' == $data['setting-img_settings_vertical_crop_option'] ) {
				$height = '';
			} else {
				if($h != '' && isset($h)){
					$height = $h;
