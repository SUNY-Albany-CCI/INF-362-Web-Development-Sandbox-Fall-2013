...
<div id="post-<?php the_ID(); ?>" <?php post_class("post clearfix " . $themify->get_categories_as_classes(get_the_ID())); ?>>
	...
	<div class="post-content">
		...
		<?php else: ?>
		     ...
		     <br/>
		     <h2>Manufacturer</h2>
		     <?php $cat = get_the_terms( $post->ID, 'car_category' ); ?>
		     ...
		     <p><?php echo $cfs->get('specifications'); ?></p>
		     <br/>
		     <h2>Features</h2>
		     <p><?php echo $cfs->get('features'); ?></p>
		     <h2>General Comments</h2>
		     <p><?php echo $cfs->get('general_comments'); ?></p>
		     <h2>Photos</h2>
		     <?php $fields = $cfs->get('photos'); ?>
		     <?php foreach ($fields as $field) : ?>
		          <img src="<?php echo $field['photo']; ?>" alt="">
		     <?php endforeach; ?>
		     <h2>Reviews</h2>
		     <?php $fields = $cfs->get('admin_reviews'); ?>
		     <?php foreach ($fields as $field) : ?>
		     <div class="review">
		          <p><b>Reviewer Name: <?php echo $field['name']; ?></b></p>
		          <p><b>Review: </b><?php echo $field['review']; ?></p>
		</div>
		     <?php endforeach; ?>

		     <p><em>Sourced From: <?php echo $cfs->get('sourced_from'); ?></em></p>
